...
- [x] アイコンライブラリが導入されている
- [x] デバイスアイコンが SVG アイコンに置き換わっている
- [x] センサーバッジのアイコンが SVG に置き換わっている
- [x] AC コントロールのアイコンが SVG に置き換わっている
- [x] テーマ切替アイコンが SVG に置き換わっている
- [x] ライトモード・ダークモード両方で適切に表示される
- [x] アイコンサイズが各コンテキストで統一されている
