...
- [x] 設定ボタン押下でポップアップ内にオプション画面が表示される
- [x] オプション画面に戻るボタンがあり、デバイスリスト画面に戻れる
- [x] API キー設定、言語設定、デバイス設定、セキュリティ設定が正しく動作する
- [x] オプション画面がポップアップのサイズ内に収まり、スクロール可能である
- [x] Options エントリーポイント（別タブ）が引き続き動作する
- [x] ダークモードで正しく表示される
